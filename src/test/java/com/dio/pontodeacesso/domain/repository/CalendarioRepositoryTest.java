...
class CalendarioRepositoryTest extends MySqlTest {
    ...
    void save_PersistCalendario_WhenSuccessful(){
        ...
        Calendario calendarioToBeSaved = createValidCalendario();
    ...
    void save_PersistCalendarioThrowDataIntegrityViolationException_WhenSuccessful(){
        ...
        Calendario calendarioToBeSaved = createInvalidCalendario();
    ...
    private Calendario createValidCalendario(){
    ...
    private Calendario createInvalidCalendario(){
        return Calendario.builder()
                .descricao("Novo Calendario")
                .dataEspecial(OffsetDateTime.now())
